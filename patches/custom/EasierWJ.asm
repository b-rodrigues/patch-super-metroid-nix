; Easier Wall Jump by Benox50
; Source: https://metroidconstruction.com//files/assembly/545/EasierWJ.asm
; Credit: https://metroidconstruction.com/resource.php?id=545
lorom
